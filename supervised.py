...
def main():
    ...
    num_batches_per_epoch = len(trainset) // cfg['batch_size']
    trainloader = DataLoader(
        trainset, batch_size=cfg['batch_size'], pin_memory=False, num_workers=0, drop_last=True, #pin_memory=True 4
    ...
    valloader = DataLoader(
        valset, batch_size=1, pin_memory=False, num_workers=0, drop_last=False,  #pin_memory=True 4 1
        # sampler=valsampler
        shuffle=True
    )
    ...
    for epoch in range(epoch + 1, cfg['epochs']):
        ...
        for i, (img, mask) in enumerate(trainloader):
            ...
            iters = epoch * num_batches_per_epoch + i
